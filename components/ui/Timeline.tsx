        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white flex items-center justify-center shadow-sm border border-slate-200">
                <div className="h-4 w-4 rounded-full bg-[#0145F2] border border-blue-200 p-2" />
              </div>
              {/* Título lateral (Desktop) */}
              <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-black text-[#0145F2]/20 drop-shadow-sm">
                {item.title}
              </h3>
            </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              ...
              <h3 className="md:hidden block text-3xl mb-4 text-left font-black text-[#0145F2]/30 drop-shadow-sm">
                {item.title}
              </h3>
              {item.content}
            </div>
