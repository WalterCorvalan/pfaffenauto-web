...
export default function ToggleTemaPublico() {
  ...
  return (
    <button
      ...
      className="absolute top-[5.5rem] right-4 lg:right-6 z-40 w-14 h-8 rounded-full bg-slate-100/90 dark:bg-white/10 backdrop-blur-md border border-black/5 dark:border-white/15 shadow-lg dark:shadow-[0_4px_20px_rgba(0,0,0,0.4)] flex items-center px-1 transition-colors"
    >
      <span
