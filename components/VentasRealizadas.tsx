...
export default function VentasRealizadas() {
  return (
    <section className="py-10 md:py-24 bg-[#f8f9fa] border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 md:px-6">

        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
          <div className="max-w-2xl">
            <span className="text-blue-600 text-[11px] font-bold uppercase tracking-widest flex items-center gap-1.5 mb-3">
              <Camera className="w-3.5 h-3.5" /> Entregas reales
            </span>
            <h2 className="text-3xl md:text-5xl text-gray-900 font-black tracking-tight leading-tight">
              Autos que ya <span className="text-blue-600">entregamos.</span>
            </h2>
          </div>
          <a
            ...
            className="inline-flex items-center gap-2 text-sm font-bold text-blue-600 hover:text-blue-800 transition-colors shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0145F2] rounded-md"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
          {PUBLICACIONES.map((p) => (
            <a
              ...
              className="group relative aspect-[4/5] rounded-[24px] overflow-hidden border border-gray-200 shadow-sm hover:border-blue-400 hover:shadow-md hover:-translate-y-1 transition-all duration-300 block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0145F2]"
            >
              <img
                src={p.imagen}
                alt={p.titulo}
