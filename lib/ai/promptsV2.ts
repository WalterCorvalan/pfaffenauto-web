...
Respondé SIEMPRE en este formato JSON exacto, sin texto fuera del JSON:
{
  ...
  "datos_detectados": { "timing": null o string, "forma_pago": null o string, "tiene_permuta": null o boolean, "nombre": null o string, "email": null o string, "telefono": null o string, "cuil": null o string (ver regla CUIL), "precio_pedido": null o string (ver regla VENTA/CONSIGNACIÓN/PERMUTA), "zona": null o "casa-central" | "don-torcuato" (ver regla VENTA/CONSIGNACIÓN/PERMUTA), "dia_visita": null o string con fecha puntual confirmada (ej: "lunes 14", no solo "lunes" — ver regla VENTA/CONSIGNACIÓN/PERMUTA), "horario_visita": null o string dentro de 9 a 16 hs (ver regla VENTA/CONSIGNACIÓN/PERMUTA), "vehiculo_propio": null o { "marca": string o null, "modelo": string o null, "anio": string o null } (el auto que el cliente ofrece — vender/consignar/permutar, nunca stock) },
