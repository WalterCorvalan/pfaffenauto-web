...
import { UserCircle2, X, Save } from "lucide-react";

export default function VendedorEditor({
  vehiculoId, vendedorId, vendedorNombre, perfiles, onActualizado,
}: {
  vehiculoId: string; vendedorId: string | null; vendedorNombre: string | null;
  perfiles: { id: string; nombre: string }[]; onActualizado: (id: string, cambios: any) => void;
}) {
