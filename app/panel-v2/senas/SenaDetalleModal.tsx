      ...
      <div className="bg-white dark:bg-[#111] border border-slate-200 dark:border-white/10 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="px-5 pb-5 space-y-4">
          ...
          <div className="flex gap-2 pt-1">
            <Link href={`/panel-v2/senas/imprimir/${s.id}`} className="flex-1 flex items-center justify-center gap-2 bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 text-slate-700 dark:text-slate-200 font-bold text-sm py-2.5 rounded-xl transition-colors">
