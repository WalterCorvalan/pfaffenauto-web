...
export default async function PedidosPage() {
  ...
  const [{ data: pedidos }, { data: vendedores }, { data: clientes }] = await Promise.all([
    supabase
      .from("pedidos")
  ...
  return <PedidosClient pedidosIniciales={pedidos || []} vendedores={vendedores || []} clientes={clientes || []} miId={user?.id || ""} />;
}
