      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="relative h-40 w-full rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.1)] dark:shadow-none md:h-52 lg:h-64 border border-white/50 dark:border-white/10">
              <Image src="/VDM.jpeg" alt="Sede Casa Central" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
            </div>
            <div className="relative h-40 w-full rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.1)] dark:shadow-none md:h-52 lg:h-64 border border-white/50 dark:border-white/10">
              <Image src="https://images.unsplash.com/photo-1560958089-b8a1929cea89?q=80&w=1200&auto=format&fit=crop" alt="Primeros clientes" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
            </div>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="relative h-40 w-full rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.1)] dark:shadow-none md:h-52 lg:h-64 border border-white/50 dark:border-white/10">
              <Image src="/pana.jpg" alt="Sucursal Don Torcuato" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
            </div>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="relative h-40 w-full rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.1)] dark:shadow-none md:h-52 lg:h-64 border border-white/50 dark:border-white/10">
              <Image src="https://images.unsplash.com/photo-1619767886558-efeb9c0a149f?q=80&w=1200&auto=format&fit=crop" alt="Innovación Tecnológica" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
            </div>
            <div className="relative h-40 w-full rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.1)] dark:shadow-none md:h-52 lg:h-64 border border-white/50 dark:border-white/10">
              <Image src="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?q=80&w=1200&auto=format&fit=crop" alt="Autos de Alta Gama" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
            </div>
          </div>
