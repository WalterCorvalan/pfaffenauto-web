...
export default async function MarcaPage({
  ...
  if (!vehiculos || vehiculos.length === 0) {
    return (
      <div className="min-h-[80vh] bg-[#E9ECEF] dark:bg-[#0a0a0f] relative overflow-hidden flex flex-col items-center justify-center px-4 w-full">
        <div className="absolute top-[20%] left-[-10%] w-[500px] h-[500px] bg-[#0145F2]/10 dark:bg-sky-400/10 rounded-full blur-[100px] pointer-events-none z-0"></div>

        <div className="bg-white/40 dark:bg-white/5 backdrop-blur-3xl border border-white/60 dark:border-white/10 rounded-[40px] p-8 md:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-none text-center relative z-10 max-w-xl">
          <div className="w-20 h-20 bg-white/60 dark:bg-white/10 rounded-full flex items-center justify-center mx-auto mb-6 shadow-inner border border-white/80 dark:border-white/10">
             <ShieldCheck className="w-8 h-8 text-gray-400 dark:text-slate-500" />
          </div>
          <h2 className="text-3xl font-black text-navy dark:text-white mb-4 tracking-tight drop-shadow-sm">
            No hay stock de {marcaName}
          </h2>
          <p className="text-gray-600 dark:text-slate-400 font-medium mb-8 text-sm md:text-base leading-relaxed">
          ...
          <br/>
          <Link href="/marcas" className="text-[#0145F2] dark:text-sky-300 font-black hover:text-navy dark:hover:text-white text-xs uppercase tracking-widest transition-colors">
            Volver a Marcas
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#E9ECEF] dark:bg-[#0a0a0f] font-sans text-foreground pb-24 relative overflow-hidden">

      {/* ================= LUCES AMBIENTALES ================= */}
      <div className="absolute top-[-5%] left-[-10%] w-[600px] h-[600px] bg-slate-400/10 rounded-full blur-[120px] pointer-events-none z-0"></div>
      <div className="absolute top-[10%] right-[-5%] w-[500px] h-[500px] bg-[#0145F2]/10 dark:bg-sky-400/10 rounded-full blur-[120px] pointer-events-none z-0"></div>
      ...
      <div className="relative w-full pt-10 pb-16 px-4 md:px-6 z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-[10px] sm:text-xs text-gray-500 dark:text-slate-400 font-bold uppercase tracking-widest mb-8 flex items-center gap-2 justify-center">
            ...
            <Link href="/marcas" className="hover:text-[#0145F2] dark:hover:text-sky-300 transition-colors">Marcas</Link>
            <span className="text-gray-400 dark:text-slate-600">/</span>
            <strong className="text-navy dark:text-white">{marcaName}</strong>
          </div>

          <div className="bg-white/40 dark:bg-white/5 backdrop-blur-3xl border border-white/60 dark:border-white/10 rounded-[40px] p-8 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-none text-center relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <h1 className="text-3xl md:text-5xl font-black text-navy dark:text-white tracking-tighter mb-4 drop-shadow-sm uppercase">
                Modelos <span className="text-transparent bg-clip-text bg-gradient-to-r from-navy to-[#0145F2] dark:from-white dark:to-sky-400">{marcaName}</span>
              </h1>

              <p className="text-sm md:text-base text-gray-600 dark:text-slate-400 font-medium mb-8 leading-relaxed max-w-xl">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {marcaInfo.pills.map((pill, idx) => (
                  <span
                    key={idx}
                    className="bg-white/50 dark:bg-white/10 backdrop-blur-md border border-white/80 dark:border-white/10 text-navy dark:text-white text-[10px] md:text-xs font-black uppercase tracking-widest px-4 py-2 rounded-full shadow-[0_4px_10px_rgba(0,0,0,0.02)] dark:shadow-none"
                  >
                    {pill}
                  </span>
                ))}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center mb-8">
          <span className="bg-blue-500/10 dark:bg-sky-400/10 backdrop-blur-md border border-blue-500/20 dark:border-sky-400/20 text-[#0145F2] dark:text-sky-300 text-[10px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full">
            <strong className="text-navy dark:text-white">{vehiculos.length}</strong> modelos encontrados
          </span>
        </div>
