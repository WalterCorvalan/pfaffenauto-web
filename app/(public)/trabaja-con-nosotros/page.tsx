            ...
            <div className="bg-white/90 dark:bg-white/5 backdrop-blur-2xl rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-none border border-white dark:border-white/10 p-6 sm:p-10 relative overflow-hidden">
              {success ? (
                <div className="flex flex-col items-center justify-center py-16 text-center animate-fadeIn">
                  ...
                  <h2 className="text-2xl font-black text-[#0f293e] dark:text-white mb-3 uppercase tracking-tight">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <h2 className="text-xl font-black text-[#0f293e] dark:text-white mb-1">
                      Dejanos tus datos
                    </h2>
                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                      Completá el formulario para ingresar a nuestra base de
                      talentos.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest pl-1">
                        Nombre
                      </label>
                    ...
                    >
                      {archivoCV ? (
                        <div className="flex flex-col items-center gap-2">
                          ...
                          <span className="text-sm font-black text-[#0f293e] dark:text-white mt-1">
                            {archivoCV.name}
                          </span>
                          <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500 hover:text-[#0145F2] dark:hover:text-sky-300">
                        ...
                        <div className="flex flex-col items-center gap-2">
                          ...
                          <span className="text-sm font-bold text-[#0f293e] dark:text-white">
