...
export const metadata: Metadata = {
  title: "Trabajá con Nosotros | Pfaffen Autos",
  description: "Sumate al equipo de Pfaffen Autos. Buscamos personas proactivas para Ventas, Administración, Marketing, Taller y más. Postulate online.",
