...
export default async function OutletPage() {
  ...
  return (
    <div className="min-h-screen bg-[#E9ECEF] dark:bg-[#0a0a0f] font-sans text-foreground pb-20 relative overflow-hidden">
      ...
      <div className="absolute top-[-5%] right-[-5%] w-[600px] h-[600px] bg-orange-400/10 dark:bg-orange-400/5 rounded-full blur-[120px] pointer-events-none z-0"></div>
      ...
      <div className="relative w-full pt-12 pb-16 px-4 md:px-6 z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-[10px] sm:text-xs text-gray-500 dark:text-slate-400 font-bold uppercase tracking-widest mb-8 flex items-center gap-2 justify-center">
            ...
            <strong className="text-navy dark:text-white">Outlet</strong>
          </div>
          ...
          <div className="bg-white/40 dark:bg-white/5 backdrop-blur-3xl border border-white/60 dark:border-white/10 rounded-[40px] p-8 md:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-none text-center relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <span className="flex items-center gap-2 bg-gradient-to-r from-blue-100/80 to-sky-100/80 dark:from-sky-400/10 dark:to-blue-400/10 backdrop-blur-md text-[#0145F2] dark:text-sky-300 border border-blue-200/80 dark:border-sky-400/20 text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-full mb-6 shadow-sm">
      ...
      <div className="max-w-3xl mx-auto px-4 relative z-10 mb-8">
        <div className="bg-blue-500/10 dark:bg-sky-400/10 backdrop-blur-xl border border-blue-500/20 dark:border-sky-400/20 py-3.5 px-6 rounded-2xl flex items-center justify-center gap-2.5 shadow-sm">
          <AlertCircle className="w-4 h-4 text-[#0145F2] dark:text-sky-300 animate-pulse" />
          <span className="text-[10px] md:text-xs font-black text-[#0145F2] dark:text-sky-300 tracking-widest uppercase text-center">
