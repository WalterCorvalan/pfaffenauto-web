      ...
      <div className="flex-1 overflow-y-auto bg-[#F9FAFB] dark:bg-[#001233] custom-scrollbar">
        <div className="hidden md:block bg-white dark:bg-[#001c55] border-b border-slate-200 dark:border-[#0a2a6b] w-full">
          <table className="w-full text-left border-collapse min-w-[900px]">
            ...
            <tbody>
              {filtradas.map((v: any) => (
                <tr key={v.id} className="border-b border-slate-100 dark:border-[#0a2a6b] hover:bg-slate-50 dark:hover:bg-[#00246b] transition-colors">
                  ...
                  <td className="p-4 whitespace-nowrap">
                    {v.etapa_seguimiento ? (
                      <span className="text-[11px] font-bold bg-indigo-50 dark:bg-[#002a6e] text-indigo-600 dark:text-sky-300 border border-indigo-100 dark:border-[#0a2a6b] px-2 py-0.5 rounded-md">{v.etapa_seguimiento}</span>
                    ) : (
