...
export default async function SeguimientoVentaPage({
  ...
  const { data: venta } = await supabase
    .from("boletos_venta")
    .select("id, numero, codigo_seguimiento, etapa_seguimiento, fecha, nombre, apellido, telefono_celular, correo_electronico, marca, modelo, dominio, venta_ars, observaciones")
    .eq("id", id)
    .single();
