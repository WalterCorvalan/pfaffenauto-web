...
export default function PresupuestoForm({ clientes, vehiculos, vendedores, sucursales, vehiculoInicial, vinculoLead }: { clientes: any[]; vehiculos: any[]; vendedores: any[]; sucursales: any[]; vehiculoInicial?: any | null; vinculoLead?: { campo: string; id: string } | null }) {
