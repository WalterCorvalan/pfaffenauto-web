...
export async function POST(request: Request) {
  try {
    ...
    const patch: Record<string, unknown> = { ig_user_id: igUserId, tono: tono || null, updated_at: new Date().toISOString() };
    ...
    registrarError("api/panel/instagram/configuracion", error);
