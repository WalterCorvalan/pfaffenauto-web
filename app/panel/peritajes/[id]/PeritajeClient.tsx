    ...
    <div className="flex flex-col h-full w-full bg-white dark:bg-[#141414] overflow-hidden">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 dark:border-white/5 px-6 py-4 bg-white dark:bg-white/[0.02] shrink-0 print:hidden">
        <div className="flex items-center gap-4">
          <Link href="/panel/peritajes" className="text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 bg-slate-50 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 p-2.5 rounded-lg border border-slate-200 dark:border-white/10 transition-colors">
