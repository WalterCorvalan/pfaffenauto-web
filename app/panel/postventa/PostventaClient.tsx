      ...
      <div className="relative bg-white dark:bg-[#141414] border border-slate-200 dark:border-white/10 w-full max-w-md rounded-2xl shadow-2xl p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button onClick={guardar} disabled={guardando} className="flex-1 py-2.5 flex items-center justify-center gap-2 text-sm font-bold bg-[#0145F2] hover:bg-[#0138c9] text-white rounded-xl disabled:opacity-50">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-4 md:p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex gap-1 mb-4 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-1 w-fit">
            <button onClick={() => setTab("recontactos")} className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold ${tab === "recontactos" ? "bg-[#0145F2] text-white" : "text-slate-500 dark:text-slate-400"}`}><Phone className="w-3.5 h-3.5" /> Recontactos</button>
            <button onClick={() => setTab("compraron")} className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold ${tab === "compraron" ? "bg-[#0145F2] text-white" : "text-slate-500 dark:text-slate-400"}`}><Repeat className="w-3.5 h-3.5" /> Ya compraron</button>
          </div>
