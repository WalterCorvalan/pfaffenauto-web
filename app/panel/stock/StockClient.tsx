    ...
    <div className="flex flex-col h-full w-full overflow-hidden">
                  ...
                  <TablaResponsiva<Vehiculo>
                    ...
                    columnas={
                      [
                        ...
                        ...(puedeEditarCompleto ? [
                          { key: "origen", header: "Origen", cell: (v: Vehiculo) => v.origen ? <span className="text-slate-500 dark:text-slate-400">{v.origen}</span> : <span className="text-slate-300 dark:text-slate-600">—</span>, claseTd: "text-sm whitespace-nowrap", ocultarEnMobile: true },
      ...
      {fichaVehiculo && (
        <FichaVehiculoModal
          ...
          onEliminar={(v) => { eliminarVehiculo(v); setFichaVehiculo(null); }}
        />
      )}
