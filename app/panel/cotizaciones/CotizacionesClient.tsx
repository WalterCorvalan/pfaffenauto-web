    ...
    <div className="flex flex-col h-full w-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto bg-slate-50 dark:bg-[#141414] p-6">
        ...
        {filtradas.length === 0 ? (
          ...
          <TablaResponsiva<Cotizacion>
            filas={filtradas}
            keyExtractor={(c) => c.id}
            encabezadoMobile={(c) => (
              <div onClick={() => setDetalle(c)} className="cursor-pointer">
            ...
            columnas={
              [
                { key: "cliente", header: "Cliente", cell: (c) => (
                ...
                { key: "precios", header: "Precios", cell: (c) => (
                  <div className="cursor-pointer text-[12px] text-slate-500 dark:text-slate-400 space-y-0.5" onClick={() => setDetalle(c)}>
                  ...
                  return (
                    <>
                      ...
                      <div className="flex flex-wrap items-center gap-1.5 mt-2.5">
                        ...
                        {tab === "aprobada" && (
                          <a href={`/panel/ventas?cotizacion=${c.id}`} className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[11px] font-bold bg-rose-50 dark:bg-rose-500/10 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-500/20"><Repeat className="w-3.5 h-3.5" /> Convertir en venta</a>
                        )}
