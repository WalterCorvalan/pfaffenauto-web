...
export default function DashboardGeneralTab(props: Props) {
  ...
  return (
    <div className="space-y-4">
        ...
        {props.esAdmin && props.ranking.length > 0 && (
          <div className="rounded-2xl p-4 bg-gradient-to-br from-indigo-600 to-violet-600 text-white">
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/panel/comisiones" className="text-xs font-bold text-white/80 hover:underline shrink-0">Ver más →</Link>
            </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <Tile label="Disponible" valor={props.stockDisponible} icon={Car} color="sky" href="/panel/stock" />
        <Tile label="Reservados / Señados" valor={props.stockReservado + props.stockSenado} icon={Car} color="sky" href="/panel/stock" />
        <Tile label="Vendidos (histórico)" valor={props.stockVendido} icon={Car} color="sky" href="/panel/stock" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <Tile label="Recordatorios hoy" valor={props.recordatoriosHoy} icon={CalendarClock} color="indigo" href="/panel/calendario" />
        ...
        <Tile label="Cotizaciones activas" valor={props.cotizacionesActivas} icon={Receipt} color="indigo" href="/panel/cotizaciones" />
        <Tile label="Expedientes activos" valor={props.expedientesActivos} icon={FolderKanban} color="indigo" href="/panel/expedientes" />
        <Tile label="Infracciones pendientes" valor={props.infraccionesPendientes} icon={Landmark} color="rose" alerta={props.infraccionesPendientes > 0} href="/panel/infracciones" />
        <Tile label="Pedidos activos" valor={props.pedidosActivos} icon={SearchCode} color="indigo" href="/panel/pedidos" />
      </div>
      ...
      <div className="rounded-2xl p-5 bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/5">
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/panel/finanzas" className="text-xs font-bold text-amber-600 hover:underline shrink-0">Ver más →</Link>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="rounded-2xl p-4 bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/5">
          <div className="flex items-center justify-between mb-2">
            ...
            <Link href="/panel/mis-ventas" className="text-xs font-bold text-amber-600 hover:underline shrink-0">Ver más →</Link>
          </div>
        ...
        <div className="rounded-2xl p-4 bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/5">
          <div className="flex items-center justify-between mb-2">
            ...
            <Link href="/panel/finanzas" className="text-xs font-bold text-violet-600 hover:underline shrink-0">Ver más →</Link>
          </div>
        ...
        <div className="rounded-2xl p-4 bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/5">
          <div className="flex items-center justify-between mb-2">
            ...
            <Link href="/panel/mi-espacio?tab=cuotas-pagar" className="text-xs font-bold text-emerald-600 hover:underline shrink-0">Ver más →</Link>
          </div>
