          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              {consignacion.vehiculo_id ? (
                <a href={`/panel/stock?vehiculo=${consignacion.vehiculo_id}`} className="flex items-center gap-1 text-[11px] font-bold text-emerald-600 dark:text-emerald-400"><ExternalLink className="w-3 h-3" /> Ver en Stock</a>
              ) : (
