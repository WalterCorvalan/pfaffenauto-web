...
import { X, Loader2, Save, Trash2, Plus, Bell, Star, Search, Check, Megaphone, CreditCard, ExternalLink } from "lucide-react";
      ...
      <div className="relative bg-white dark:bg-[#141414] border border-slate-200 dark:border-white/10 w-full max-w-2xl max-h-[90vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="space-y-4 px-6 py-4 overflow-y-auto overflow-x-hidden flex-1 min-h-0">
          ...
          <a
            ...
            className="flex items-center justify-center gap-1.5 text-[11px] font-bold text-sky-700 dark:text-sky-300 bg-sky-50 dark:bg-sky-500/10 border border-sky-100 dark:border-sky-500/20 rounded-lg px-3 py-2 w-fit"
          >
            <CreditCard className="w-3.5 h-3.5" /> Simular financiación en decreditos <ExternalLink className="w-3 h-3" />
          </a>
