...
- `PapeleraClient.tsx` pide `/api/panel/papelera` sin `tipo` para los conteos de los chips y con `tipo` para el listado — son dos formas de la misma GET, no dos endpoints.
