      ...
      <div className="flex items-start justify-between gap-3 mb-1 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {/* Decía "(filtro)" pero ingresoAgenciaTotal se calcula sobre
              ...
              proceso) -- no sobre los filtros de mes/búsqueda/estado que
              viven como estado local dentro de TransferenciasTab.tsx. No
              cambia con lo que el usuario filtra en esa pestaña. */}
          <span className="text-xs text-slate-400">Ingreso agencia (terminadas, período cargado): <b className="text-slate-700 dark:text-white">{gananciasOcultas ? "—" : fmt(ingresoAgenciaTotal)}</b></span>
